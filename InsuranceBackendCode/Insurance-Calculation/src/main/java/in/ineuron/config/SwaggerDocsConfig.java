...
public class SwaggerDocsConfig {
	...
	private ApiInfo getApiInfo() {
		Contact contact = new Contact("sanyam", "http://www.ineuron.ai/course", "singhsanyam577@gmail.com");
		return new ApiInfo("InsurancePolicyInfo", "Gives information about insurance policy", "3.4.RELEASE", "http:", contact,
				"GNU PUBLIC", "http://apache.org/license/guru", Collections.emptyList());
	}
}

//url http://laptop-1fne9bq7:1111/swagger-ui.html
